...
public class FavFriendsFragment extends Fragment {
    //in this fragment we'll draw a bar chart for the 5 most favorite friends (the friends you sent most messages to)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Drawing view = new Drawing(getActivity(), friendsNo, topFriendsNames, rightValues);
        return inflater.inflate((XmlPullParser) view, container, false);
    }
